...
```{r plot_jellyfish, fig.width=6, fig.height=5}
plot(mod)
```
...
```{r plot_predictions, fig.width=6, fig.height=5}
plot(predict(mod))
```
...
```{r plot_accuracy, fig.width=6, fig.height=5}
plot(accuracy(mod))
```
...
```{r plot_cval_dist, fig.width=6, fig.height=5}
