...
expect_equal(length(predict(m1)), nrow(test_dat_int))
expect_equal(predict(m1), c("1","1","2","1","1","1","1","2","1","2","2","2","2","1","2","2","2","2"))
expect_equal(length(accuracy(m1)), nrow(test_dat_int))
...
expect_equal(length(predict(m2)), nrow(test_dat_int))
expect_equal(predict(m2), c("1:1", "1:2", "2:1", "1:1", "1:2", "1:1", "1:1", "2:1", "1:1", "2:1",
                            "2:1", "2:1", "2:1", "1:1", "2:1", "2:1", "2:1", "2:1"))
expect_equal(length(accuracy(m2)), nrow(test_dat_int))
expect_equal(accuracy(m2), c("correct","correct","incorrect","correct","correct","correct","correct",
...
expect_equal(length(predict(m3)), nrow(test_dat_nas))
expect_equal(predict(m3), c("1","1","2","1","1","1","1","2","1","2","2","2","2","1","2","2","2","2"))
expect_equal(length(accuracy(m3)), nrow(test_dat_nas))
expect_equal(accuracy(m3), c("correct","correct","incorrect","correct","correct","correct",
...
expect_equal(length(predict(m4)), nrow(test_dat_char))
expect_equal(predict(m4), c("music:m","music:f","noise:m","music:m","music:f","music:m",
                            "music:m","noise:m","music:m","noise:m","noise:m","noise:m",
                            "noise:m","music:m","noise:m","noise:m","noise:m","noise:m"))
expect_equal(length(accuracy(m4)), nrow(test_dat_char))
expect_equal(accuracy(m4), c("correct","correct","incorrect","correct","correct","correct","correct",
                             "incorrect","incorrect","correct","correct","correct","incorrect",
                             "incorrect","incorrect","incorrect","incorrect","correct"))
# check functions called for side-effects
...
expect_equal(length(predict(m5)), nrow(test_dat_fac))
expect_equal(predict(m5), c("music:m","music:f","noise:m","music:m","music:f","music:m",
                            "music:m","noise:m","music:m","noise:m","noise:m","noise:m",
                            "noise:m","music:m","noise:m","noise:m","noise:m","noise:m"))
expect_equal(length(accuracy(m5)), nrow(test_dat_fac))
expect_equal(accuracy(m5), c("correct","correct","incorrect","correct","correct","correct","correct",
                             "incorrect","incorrect","correct","correct","correct","incorrect",
                             "incorrect","incorrect","incorrect","incorrect","correct"))
# check functions called for side-effects
...
expect_equal(length(predict(m6)), nrow(test_dat_float))
expect_equal(predict(m6), c("1","1","2","1","1","1","1","2","1","2","2","2","2","1","2","2","2","2"))
expect_equal(length(accuracy(m6)), nrow(test_dat_float))
expect_equal(accuracy(m6), c("correct","correct","incorrect","correct","correct","correct","correct",
                             "incorrect","correct","correct","correct","correct","correct","incorrect",
                             "correct","correct","correct","correct"))
# check functions called for side-effects
...
expect_equal(round(clubpro:::c_pcc(test_dat_int$items, 
             clubpro:::to_indicator_matrix(test_dat_int$condition), 
